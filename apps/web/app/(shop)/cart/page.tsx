...
import { Trash2, ShoppingBag, Lock, ArrowRight, UserPlus } from "lucide-react";
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {items.length === 0 ? (
          ...
          <>
            {/* Login CTA Banner — shown only for anonymous users */}
            {!user && (
              <div className="bg-gradient-to-r from-primary-50 to-primary-100/50 border border-primary-200 rounded-xl p-4 mb-6">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-0.5">
                        Your cart is stored locally — login to persist it across devices
                      </p>
                    </div>
                  </div>
      ...
      <LoginModal
        ...
        context="Login to save your cart and proceed to checkout"
      />
    </>
  );
}
