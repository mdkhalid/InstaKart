      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input name="lat" value={form.lat} onChange={handleChange} required type="number" step="any" className="w-full border rounded-lg px-3 py-2 text-sm" placeholder="e.g. 19.076" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Longitude *</label>
            <input name="lng" value={form.lng} onChange={handleChange} required type="number" step="any" className="w-full border rounded-lg px-3 py-2 text-sm" placeholder="e.g. 72.8777" />
          </div>
        </div>
